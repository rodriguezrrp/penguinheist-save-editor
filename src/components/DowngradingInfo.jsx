        ...
        <table id="tableManifests" className="table table-bordered table-sm border-dark">
          <thead>
            ...
            <tr>
              <th scope="col">
                <BiLogoWindows aria-hidden="true" className="icon" />{' '}
                Windows (<span className="fw-500 game-version-depot-windows">{depotsInfo.depot_windows}</span>)
              </th>
              <th scope="col">
                <BiLogoApple aria-hidden="true" className="icon" />{' '}
                MacOS (<span className="fw-500 game-version-depot-macos">{depotsInfo.depot_macos}</span>)
              </th>
              <th scope="col">
                {/* <svg xmlns="http://www.w3.org/2000/svg" class="icon" aria-hidden="true" viewBox="0 0 448 512">
                    <!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                ...
                <FaLinux aria-hidden="true" className="icon" />{' '}
                Linux (<span className="fw-500 game-version-depot-linux">{depotsInfo.depot_linux}</span>)
              </th>
            </tr>
          </thead>
