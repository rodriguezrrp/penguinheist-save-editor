...
export default function DowngradingInfo() {
  ...
  return <>
      ...
      <div className="text-container">
        ...
        <ol>
          ...
          <li>
            ...
            <p>
              You should see a message like "<span className="mono-text fw-600">Downloading Depot 1451481 ...</span>" appear.
          ...
          <li>
            ...
            <p>After a successful download you should see a message that looks something like:
              ...
              {/* <!-- <ul><li>
                ...
                <br/><span className="mono-text fw-500">Depot download complete : "C:\Program Files (x86)\Steam\steamapps\content\app_1451480\depot_1451481" (273 files, manifest 6080836104571247089)</span>
              </li></ul> --> */}
              <br/>
          ...
          <li>
            ...
            <p>Anytime you want to run the game version, just run the game executable file (
              <BiLogoWindows aria-label="On Windows" className="icon" /> <span className="mono-text fw-normal">Penguin Heist.exe</span>,
              {' '}<BiLogoApple aria-label="On Mac OS" className="icon" /> <span className="mono-text fw-normal">Penguin Heist.app</span>,
              or <FaLinux aria-label="On Linux" className="icon" /> <span className="mono-text fw-normal">PenguinHeist</span>),
          ...
          <li>
            ...
            <p>If you want to run this copy of the game from Steam just like you run the original one, You can add the game executable to Steam as a non-Steam game.
            </p>
            <p>
      ...
      <div id={idSaveLocationCard} className="card" style={{margin: '1em'}}>
        ...
        <div className="text-container">
          ...
          <p>
            ...
            folder "<span class="mono-text">Penguin Heist</span>" or file "<span class="mono-text">PHSaveMain.sav</span>"
          ...
          <ul class="listicons">
            <li class="listicons">
              <span class="listicons"><BiLogoWindows aria-hidden="true" className="icon" /></span>
              {/* <p>On Windows: folder "<span class="mono-text">%appdata%/../LocalLow/FishSoft/Penguin&nbsp;Heist/</span>".</p> */}
              <p>On Windows: folder "<span class="mono-text"><abbr title="%userprofile%/AppData/">%appdata%/../</abbr>LocalLow/FishSoft/Penguin&nbsp;Heist/</span>".</p>
              <p className="form-text">
                ...
                enter "<span class="mono-text">%appdata%</span>" and click Ok,
                then in the file explorer window, in the address bar near the top, click "<span class="mono-text">LocalLow</span>"
                and navigate to "<span class="mono-text">FishSoft</span>" &gt; "<span class="mono-text">Penguin Heist</span>".
              </p>
            </li>
            <li class="listicons">
              <span class="listicons"><BiLogoApple aria-hidden="true" className="icon" /></span>
              <p>On Mac: folder "<span class="mono-text">~/Library/Application&nbsp;Support/FishSoft/Penguin&nbsp;Heist/</span>".</p>
              <p className="form-text">
            ...
            <li class="listicons">
              ...
              <p>
                ...
                On Linux: folder "<span class="mono-text">$HOME/.config/unity3d/Penguin&nbsp;Heist/</span>"
                <br/> or in "<span class="mono-text"><abbr title="The base Steam installation folder">&lt;Steam-folder&gt;</abbr>/steamapps/compatdata/1451480/pfx/</span>".
                <p className="form-text">
    ...
    >
      ...
      {/* <div style={{paddingLeft:'.5em', paddingRight:'.5em', lineHeight:'1.2'}}> */}
        <div className="text-container">
          <p class="form-text">
          ...
          <p>The command looks like "<span class="mono-text inline-code">download_depot &lt;AppID&gt; &lt;DepotID&gt; &lt;ManifestID&gt;</span>".</p>

          <p>
            The App ID is always "1451480" for Penguin Heist.
            <br/>The Depot ID is dependent on the target operating system only:
            <ul class="listicons">
              <li class="listicons inst-windows">
                <span class="listicons"><BiLogoWindows aria-hidden="true" className="icon" /></span>
                On Windows: "<span class="game-version-depot-windows">{depotsInfo.depot_windows}</span>"
              </li>
              <li class="listicons inst-macos">
                <span class="listicons"><BiLogoApple aria-hidden="true" className="icon" /></span>
                On MacOS: "<span class="game-version-depot-macos">{depotsInfo.depot_macos}</span>"
              </li>
              <li class="listicons inst-linux">
                <FaLinux aria-hidden="true" className="icon" />
                {/* <span class="listicons">
                ...
                On Linux: "<span class="game-version-depot-linux">{depotsInfo.depot_linux}</span>"
              </li>
            </ul>
            The Manifest ID depends on both the Depot and the game version. Refer to the table below:
          </p>
          
          <table id="tableManifests" class="table table-bordered table-sm border-dark">
            <thead>
              <tr>
              ...
              <tr>
                <th scope="col">
                  <BiLogoWindows aria-hidden="true" className="icon" />
                  Windows (<span class="fw-500 game-version-depot-windows">{depotsInfo.depot_windows}</span>)
                </th>
                <th scope="col">
                  <BiLogoApple aria-hidden="true" className="icon" />
                  MacOS (<span class="fw-500 game-version-depot-macos">{depotsInfo.depot_macos}</span>)
                </th>
                <th scope="col">
                  {/* <svg xmlns="http://www.w3.org/2000/svg" class="icon" aria-hidden="true" viewBox="0 0 448 512">
                      <!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                  ...
                  Linux (<span class="fw-500 game-version-depot-linux">{depotsInfo.depot_linux}</span>)
                </th>
              </tr>
            </thead>
