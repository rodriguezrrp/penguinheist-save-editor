const UNITY_MAPPING_KEYBOARD = {};
const UNITY_MAPPING_MOUSE = {};

const kc = (key, unitykey) => UNITY_MAPPING_KEYBOARD[key] = unitykey;
const mc = (button, unitykey) => UNITY_MAPPING_MOUSE[button] = unitykey;
...
function handleKeyDown(e, unityCodeCallback) {
...
function handleMouseUp(e, unityCodeCallback) {
