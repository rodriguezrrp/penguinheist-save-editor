...
if __name__ == '__main__':
    ...
    ## 4. move the version-dependent dropdown value data into javascript files

    with open('../docs/js/dropdown_maps_generated.js', 'w') as jsf:
        # comment notifying people who open the file that it was generated (by this script)
        jsf.write('// generated by the mapping script\n')
        ...
        jsf.write('const DROPDOWN_MAPS = {};\n'.format(json.dumps(contents_dropdowns, indent=4)))
